...
('Jaina', 'Proudmoore', '1975-05-15', 'jaina@frostmourne.com', '555-1234', '2024-12-20 10:00:00', TRUE, 1),
('Thrall', 'Haut-Shaman', '1980-08-22', 'thrall@shadowfang.com', '555-5678', '2024-12-21 11:30:00', TRUE, 2),
('Tyrande', 'Whisperwind', '1972-03-30', 'tyrande@moonfall.com', '555-8765', '2024-12-22 09:15:00', TRUE, 3),
('Garrosh', 'Hellscream', '1983-07-19', 'garrosh@warsong.com', '555-4321', '2024-12-23 14:45:00', TRUE, 4),
('Khadgar', 'Mage-Réformé', '1965-11-05', 'khadgar@kirintor.com', '555-6543', '2024-12-24 08:20:00', TRUE, 5),
('Anduin', 'Lothar', '1978-02-14', 'anduin@lionofazeroth.com', '555-7890', '2024-12-25 12:30:00', TRUE, 6),
('Grommash', 'Hellscream', '1968-09-09', 'grommash@warsong.com', '555-3210', '2024-12-26 16:00:00', TRUE, 7),
('Sylvanas', 'Windrunner', '1981-04-27', 'sylvanas@forsaken.com', '555-2134', '2024-12-27 09:45:00', TRUE, 8),
('Medivh', 'Gardien', '1960-06-18', 'medivh@guardian.com', '555-3412', '2024-12-28 11:15:00', TRUE, 9),
('Arthas', 'Menethil', '1969-12-05', 'arthas@frostmourne.com', '555-4321', '2024-12-29 13:30:00', TRUE, 10),
('Genn', 'Greymane', '1977-08-08', 'genn@gilneas.com', '555-5678', '2024-12-30 15:45:00', TRUE, 11),
('Uther', 'the Lightbringer', '1955-01-01', 'uther@lightbringer.com', '555-6789', '2024-12-31 17:00:00', TRUE, 12),
('Rexxar', 'Champion', '1985-03-12', 'rexxar@beastmaster.com', '555-7890', '2025-01-01 10:30:00', TRUE, 13),
('Cairne', 'Bloodhoof', '1962-04-04', 'cairne@tauren.com', '555-8901', '2025-01-02 09:00:00', TRUE, 14),
('Taretha', 'Foxton', '1970-05-25', 'taretha@stormwind.com', '555-9012', '2025-01-03 14:10:00', TRUE, 15),
('Lor\'themar', 'Theron', '1976-07-19', 'lorthemar@qualthalas.com', '555-0123', '2025-01-04 11:20:00', TRUE, 16),
('Brann', 'Bronzebeard', '1969-10-10', 'brann@bronze.com', '555-2345', '2025-01-05 13:35:00', TRUE, 17),
('Alexandros', 'Mograine', '1974-02-28', 'alexandros@silverhand.com', '555-3456', '2025-01-06 16:50:00', TRUE, 18),
('Baelgun', 'Librarian', '1958-09-15', 'baelgun@kirintor.com', '555-4567', '2025-01-07 08:25:00', TRUE, 19),
('Elandra', 'Moonwhisper', '1983-11-22', 'elandra@moonwhisper.com', '555-5678', '2025-01-08 12:40:00', TRUE, 20),
('Valeera', 'Sanguinar', '1988-10-10', 'valeera@bloodelf.com', '555-6789', '2025-01-09 14:50:00', TRUE, 1),
('Turalyon', 'Lightbringer', '1960-11-11', 'turalyon@alliance.com', '555-9876', '2025-01-10 16:10:00', TRUE, 2),
('Alleria', 'Windrunner', '1965-02-14', 'alleria@silvermoon.com', '555-3459', '2025-01-11 09:30:00', TRUE, 3),
('Bolvar', 'Fordragon', '1972-09-15', 'bolvar@dragon.com', '555-1289', '2025-01-12 18:20:00', TRUE, 4),
('Magni', 'Bronzebeard', '1955-05-05', 'magni@dwarves.com', '555-6780', '2025-01-13 12:45:00', TRUE, 5),
('Kael\'thas', 'Sunstrider', '1978-07-23', 'kaelthas@qualthalas.com', '555-4568', '2025-01-14 11:35:00', TRUE, 6),
('Illidan', 'Stormrage', '1965-12-12', 'illidan@stormrage.com', '555-6781', '2025-01-15 15:25:00', TRUE, 7),
('Maiev', 'Shadowsong', '1973-03-21', 'maiev@warden.com', '555-4569', '2025-01-16 10:15:00', TRUE, 8),
('Malfurion', 'Stormrage', '1960-06-06', 'malfurion@stormrage.com', '555-7891', '2025-01-17 13:50:00', TRUE, 9),
('Anub', 'Arak', '1950-10-10', 'anubarak@nerubian.com', '555-3450', '2025-01-18 08:30:00', TRUE, 10);
...
(1, 'jaina_p', 'hashed_pw_jaina_p'),
(2, 'thrall_h', 'hashed_pw_thrall_h'),
(3, 'tyrande_w', 'hashed_pw_tyrande_w'),
(4, 'garrosh_h', 'hashed_pw_garrosh_h'),
(5, 'khadgar_mr', 'hashed_pw_khadgar_mr'),
(6, 'anduin_l', 'hashed_pw_anduin_l'),
(7, 'grommash_h', 'hashed_pw_grommash_h'),
(8, 'sylvanas_w', 'hashed_pw_sylvanas_w'),
(9, 'medivh_g', 'hashed_pw_medivh_g'),
(10, 'arthas_m', 'hashed_pw_arthas_m'),
(11, 'genn_g', 'hashed_pw_genn_g'),
(12, 'uther_lb', 'hashed_pw_uther_lb'),
(13, 'rexxar_c', 'hashed_pw_rexxar_c'),
(14, 'cairne_b', 'hashed_pw_cairne_b'),
(15, 'taretha_f', 'hashed_pw_taretha_f'),
(16, 'lorthemar_t', 'hashed_pw_lorthemar_t'),
(17, 'brann_b', 'hashed_pw_brann_b'),
(18, 'alexandros_m', 'hashed_pw_alexandros_m'),
(19, 'baelgun_l', 'hashed_pw_baelgun_l'),
(20, 'elandra_m', 'hashed_pw_elandra_m'),
(21, 'valeera_s', 'hashed_pw_valeera_s'),
(22, 'turalyon_lb', 'hashed_pw_turalyon_lb'),
(23, 'alleria_w', 'hashed_pw_alleria_w'),
(24, 'bolvar_f', 'hashed_pw_bolvar_f'),
(25, 'magni_b', 'hashed_pw_magni_b'),
(26, 'kaelthas_s', 'hashed_pw_kaelthas_s'),
(27, 'illidan_s', 'hashed_pw_illidan_s'),
(28, 'maiev_s', 'hashed_pw_maiev_s'),
(29, 'malfurion_s', 'hashed_pw_malfurion_s'),
(30, 'anubarak_n', 'hashed_pw_anubarak_n');
